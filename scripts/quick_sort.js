...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"yellow");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"#A31D1D");//Height update
                div_update(divs[j],div_sizes[j],"#A31D1D");//Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"#118B50");//Color update
    ...
    div_update(divs[start],div_sizes[start],"#118B50");//Height update
